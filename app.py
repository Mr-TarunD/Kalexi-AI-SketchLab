...
# # --- Page Config ---
st.set_page_config(page_title="Kalexi-AI Lab", layout="wide", page_icon="⚡")
# 
...
<style>
 ...
 with st.sidebar:
     ...
     mode = st.radio("Mode", ["⚡ Instant (No AI)", "🧠 GenAI (High Quality)"])
# 
 # --- FUNCTIONS ---
 def fast_sketch(img):
...
print("⚠️ COPY THIS PASSWORD:", urllib.request.urlopen('https://ipv4.icanhazip.com').read().decode('utf8').strip("\n"))
